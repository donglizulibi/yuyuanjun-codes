...
let el2: HTMLDivElement | null = document.querySelector(".el");

// 但是上面的方法可能会导致在调用对象属性的时候没有比较好的代码提示
// 或者直接报错, 因为null没有内部属性, 无法调用
// 则可以使用非空断言, 告诉ts校验系统, 这个变量不可能是空值
let el3:HTMLDivElement = document.querySelector('.el') as HTMLDivElement

// 另一种表示非空断言的方法
let el4:HTMLDivElement = document.querySelector('.el')!
